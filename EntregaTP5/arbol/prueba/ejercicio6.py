...
file_jedi = open("EntregaTP5/arbol/prueba/jedis.txt")
...
def info_Yoda_and_Luke():
    ...
    info = get_value_from_file("EntregaTP5/arbol/prueba/jedis.txt", root.other_values)
...
def jedi_Master():
    ranking_tree.jedi_Master("EntregaTP5/arbol/prueba/jedis.txt")

#Jedi who used green lightsabers
def jedi_lightsabers():
    print("          Jedi who used green lightsabers")
    name_tree.jedi_lightsabersG("EntregaTP5/arbol/prueba/jedis.txt")

#Jedi whose masters are in the archive
def jedi_master():
    name_tree.jedi_with_Master("EntregaTP5/arbol/prueba/jedis.txt")

#Jedi with togruta or cerean species
def _jedi_specie():
    name_tree.jedi_especie("EntregaTP5/arbol/prueba/jedis.txt")
