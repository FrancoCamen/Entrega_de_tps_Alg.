...
def pokemonsRepetidos(lista_entrenadores):
    ...
    for nombre_pokemon, entrenador_list in entrenadores_por_pokemon.items():
        ...
        # else:
        #     print('nadie tiene pokemones repetidos')
...
print()
print('Recuerde que el nombre de cada entrenador debe empezar con mayuscula y el nombre de cada pokemon en minuscula')
print('----------------------------------------------------------------------')
...
print('----------------------------------------------------------------------')
print()
a = input('d. mostrar todos los datos de un entrenador y sus Pokémos: ')
...
print('----------------------------------------------------------------------')
print()
e = input('g. el promedio de nivel de los Pokémons de un determinado entrenador: ')
...
print()
print('----------------------------------------------------------------------')
print('f. (Mostrar supongo) los entrenadores que tengan Pokémons de tipo fuego y planta o agua/volador (tipo y subtipo) ')
# pokemonsRepetidos(lista_entrenadores)
...
print()
print('----------------------------------------------------------------------')
print('k. determinar si un entrenador “X” tiene al Pokémon “Y”, tanto el nombre del entrenador como del Pokémon deben ser ingresados; además si el entrenador tiene al Pokémon se deberán mostrar los datos de ambos;')
